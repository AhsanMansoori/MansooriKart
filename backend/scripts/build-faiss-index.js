...
const { EMBEDDING_DIMENSION, EMBEDDING_TASK_TYPES, embedText } = require('../services/embeddingService');
...
async function main() {
  ...
  const Product = mongoose.model('Product', new mongoose.Schema({ name: String, description: String }), 'products');
