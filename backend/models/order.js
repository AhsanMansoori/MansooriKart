...
const OrderSchema = new mongoose.Schema(
  {
    ...
    paymentStatus: { type: String, enum: ['PENDING', 'UNPAID'], default: 'PENDING' },
    status: { type: String, enum: ORDER_STATUS_ENUM, default: 'PENDING', index: true },
...
OrderSchema.statics.STATUS_ENUM = ORDER_STATUS_ENUM;
