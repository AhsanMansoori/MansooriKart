...
const { EMBEDDING_DIMENSION, EMBEDDING_TASK_TYPES, buildEmbedRequest, embedText } = require('../services/embeddingService');
...
describe('embeddingService', () => {
  ...
  it('throws when Gemini returns the wrong embedding size', async () => {
    ...
    await expect(embedText('Phone case')).rejects.toThrow(`Gemini embedding length mismatch: expected ${EMBEDDING_DIMENSION}, received 32`);
  });
});
